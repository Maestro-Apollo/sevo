                            ...
                            <div class="row h-100 align-items-center">
                                <div class="col">
                                    <div class="text-end float-lg-start custom-slider-text-block">
                                        <h2 class="text-color-secondary font-weight-extra-bold mb-4 custom-slider-text-1 appear-animation"
                                            data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
                                            <em>#</em>letslearn</h2>
                                        <h2 class="text-color-default font-weight-semi-bold mb-3 text-5 appear-animation"
                        ...
                        <div>
                            <div class="card custom-card-courses border-radius-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-2">
                                        <span class="d-inline-block pe-2"><i class="far text-primary fa-user"></i> 123
                                        </span>
                                        <span class="d-inline-block pe-2"><i class="far text-primary fa-comments"></i>
                                            123</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col px-4">
                                    ...
                                    <div class="countdown text-color-primary font-weight-semibold custom-countdown-style-1 justify-content-center mb-4 py-2 px-2"
                                        ...
                                        data-plugin-options="{'date': '2022/01/01 12:00:00', 'wrapperClass': 'text-color-primary', 'numberClass': 'font-weight-semibold text-color-primary'}">
                                    </div>
                                        ...
                                        <div class="row g-2">
                                            <div class="form-group col-md-6 mb-2">
                                                <input type="text" value=""
                                                    data-msg-required="Please enter your first name." maxlength="100"
                                                    class="form-control p-3 bg-color-tertiary" name="firstName"
                                        ...
                                        <div class="row g-2">
                                            <div class="form-group col-md-6 mb-2">
                                                <input type="text" value=""
                                                    ...
                                                    class="form-control p-3 bg-color-tertiary" name="phone" id="phone"
                            ...
                            <div
                                ...
                                <blockquote>
                                    <p class="mb-0 custom-font-1 fst-italic text-4 line-height-7">Lorem ipsum
                                        ...
                                        dolor sit amet, consectetur adipiscing elit. Sociis natoque
                                        penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce
                                        ante tellus, convallis non consectetur sed, pharetra nec ex.</p>
                                </blockquote>
                                <div class="testimonial-author">
                            ...
                            <div class="card-body p-3 z-index-1">
                                ...
                                <div class="card-body p-0">
                                    <h4 class="card-title text-5 font-weight-semi-bold pb-1 mb-2"><a
                                            ...
                                            href="education-blog.html">Lorem ipsum dolor sit amet</a></h4>
