    ...
    <div class="container">
        ...
        <div class="row py-3">
            <div class="col">
                ...
                <p class="font-weight-medium text-4">Aenean sollicitudin, lorem quis bibendum auctor, <span
                        ...
                        data-plugin-options="{'flagClassOnly': true}">nisi elit consequat ipsum</span>,
                    nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi
                ...
                <div class="row">
                    <div class="col-md-3 mb-4 mb-md-0 text-center">
                        <div class="feature-box d-flex flex-column align-items-center">
                            <div class="feature-box-icon bg-color-quaternary feature-box-icon-extra-large appear-animation"
                            ...
                            <div class="feature-box-info ps-0 appear-animation"
                                ...
                                <p class="mb-0 text-color-secondary text-4 font-weight-semi-bold">123 Porto Blvd, Suite
                                    100</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4 mb-md-0 text-center">
                        <div class="feature-box d-flex flex-column align-items-center">
                            ...
                            <div class="feature-box-info ps-0 appear-animation"
                                ...
                                <p class="mb-0 text-color-secondary text-4 font-weight-semi-bold"><a
                                        href="tel:+1234567890" class="text-color-secondary">(800) 123-4567</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4 mb-md-0 text-center">
                        <div class="feature-box d-flex flex-column align-items-center">
                            ...
                            <div class="feature-box-info ps-0 appear-animation"
                                ...
                                <p class="mb-0 text-color-secondary text-4 font-weight-semi-bold"><a
                                        ...
                                        class="text-color-secondary">porto@portotheme.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4 mb-md-0 text-center">
                        <div class="feature-box d-flex flex-column align-items-center">
                            ...
                            <div class="feature-box-info ps-0 appear-animation"
                                data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="150">
                                <p class="mt-2 pt-1 mb-0 text-1 p-relative top-5 text-uppercase">Working Days / Hours
                                </p>
                ...
                <form class="contact-form custom-form-style-1" action="php/contact-form.php" method="POST">
                    ...
                    <div class="row row-gutter-sm">
                        <div class="form-group col-lg-6 mb-4">
                            <input type="text" value="" data-msg-required="Please enter your name." maxlength="100"
                                class="form-control" name="name" id="name" required placeholder="Your Name">
                        </div>
                        <div class="form-group col-lg-6 mb-4">
                    ...
                    <div class="row row-gutter-sm">
                        <div class="form-group col-lg-6 mb-4">
                            <input type="email" value="" data-msg-required="Please enter your email address."
                                ...
                                class="form-control" name="email" id="email" required placeholder="Your Name">
                        </div>
                        <div class="form-group col-lg-6 mb-4">
                            <input type="text" value="" data-msg-required="Please enter the subject." maxlength="100"
                                class="form-control" name="subject" id="subject" required placeholder="Subject">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col mb-0">
                            <button type="submit" class="btn btn-secondary font-weight-bold btn-px-5 btn-py-3 mt-4 mb-2"
