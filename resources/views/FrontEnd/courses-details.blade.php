...
<head>
    ...
    <title>Demo Education | Porto - Responsive HTML5 Template</title>
                    ...
                    <div class="row py-3 gy-5 gy-lg-0">
                        <div class="col-lg-9 mt-0">
                            ...
                            <div class="custom-course-detail">
                                    ...
                                    <div class="ps-md-0 mb-3 mb-md-0 pe-4 border-right">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                ...
                                                <h4 class="mb-0 text-color-secondary text-4"><a href="courses-details.html" class="text-color-secondary" title="">John Doe</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="ps-md-4 mb-3 mb-md-0 flex-grow-1">
                                        <div class="d-flex flex-row align-items-center h-100">
                                            <div class="p-0">
                                                ...
                                                <h4 class="mb-0 text-color-secondary text-4"><a href="courses-details.html" class="text-color-secondary" title="">Web Development</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <p class="text-3-5 line-height-9 mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent dapibus elementum ante quis commodo. Fusce tincidunt pretium pellentesque. Nulla vitae ante tincidunt, suscipit dui sit amet, posuere tortor. Sed elementum
                                    ex fringilla, molestie nibh eu, pulvinar diam. Fusce vestibulum nisl a lectus consequat, vel semper arcu tempor. Sed ac consequat nunc.</p>
                                    ...
                                    <div class="col-md-4 mb-4 pb-1">
                                        <div class="card custom-card-courses border-radius-0 hover-effect-1">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h4 class="mb-3 text-color-secondary"><a href="courses-details.html" class="text-color-secondary" title="">Course Name Example</a></h4>
                                    ...
                                    <div class="container p-relative py-3">
                                        ...
                                        <div class="row align-items-center justify-content-center text-center">
                                            <div class="col col pt-2">
                                                ...
                                                <a href="courses.html" class="btn btn-secondary font-weight-bold btn-px-5 btn-py-3 mt-4 mb-2 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="350">GET STARTED NOW</a>
                                            </div>
                                        </div>
                                    </div>
                                </section>
            ...
            <div class="container py-5">
                <div class="row py-5">
                    <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <p class="text-3 mt-4 mb-0 line-height-8 text-color-tertiary opacity-6">Porto Education. © 2021.<br> All Rights Reserved</p>
                    ...
                    <div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
                        ...
                        <ul class="list list-unstyled opacity-6">
                            <li class="mb-1">
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Home</a>
                            </li>
                            <li class="mb-1">
                                <a href="about-us.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- About Us</a>
                            </li>
                            <li class="mb-1">
                                <a href="courses.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Courses</a>
                            </li>
                            <li class="mb-1">
                                <a href="instructors.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Instructors</a>
                            </li>
                            <li class="mb-1">
                            ...
                            <li>
                                <a href="contact-us.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
                        ...
                        <ul class="list list-unstyled opacity-6">
                            <li class="mb-1">
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Documentation</a>
                            </li>
                            <li class="mb-1">
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Forums</a>
                            </li>
                            <li class="mb-1">
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Open a Ticket</a>
                            </li>
                            <li>
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- FAQ's</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
                        ...
                        <ul class="list list-unstyled opacity-6">
                            <li class="mb-1">
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Terms of Use</a>
                            </li>
                            <li>
                                <a href="index.html" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Privacy Policy</a>
                            </li>
                        </ul>
                    </div>
                </div>
