            ...
            <div class="row py-3 gy-5 gy-lg-0">
                    ...
                    <div class="custom-course-detail">
                        ...
                        <div class="d-md-flex mb-4">
                            <div class="ps-md-0 mb-3 mb-md-0 pe-4 border-right">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <h4 class="mb-0 text-color-secondary text-4"><a href="courses-details.html"
                            ...
                            <div class="ps-md-4">
                                <div class="d-flex flex-row align-items-center h-100">
                                    <div class="p-0">
                                        <a href="#" class="btn btn-secondary font-weight-bold btn-px-5 btn-py-3">TAKE
                                            THIS COURSE</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pb-5">
                            <div class="ratio ratio-16x9">
                                <iframe src="//player.vimeo.com/video/67957799" frameborder="0" webkitallowfullscreen
                        ...
                        <p class="text-3-5 line-height-9 mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Praesent dapibus elementum ante quis commodo. Fusce tincidunt pretium pellentesque. Nulla
                            vitae ante tincidunt, suscipit dui sit amet, posuere tortor. Sed elementum
                            ex fringilla, molestie nibh eu, pulvinar diam. Fusce vestibulum nisl a lectus consequat, vel
                            semper arcu tempor. Sed ac consequat nunc.</p>

                        <div class="row align-items-md-end">
                            <div class="col-md-6">
                                <h2 class="text-color-secondary font-weight-semi-bold text-6 line-height-1 mb-4">Course
                                    Content</h2>
                            </div>
                        ...
                        <h2 class="text-color-secondary font-weight-semi-bold text-6 line-height-1 mb-3 mt-5">Reviews
                        </h2>
                            ...
                            <li>
                                <div class="comment pb-4">
                                    ...
                                    <div class="comment-block bg-transparent p-0">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra odio,
                                            gravida urna varius vitae, gravida pellentesque urna varius vitae.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>

                        <h2 class="text-color-secondary font-weight-semi-bold text-6 line-height-1 mb-4 mt-4">Related
                            Courses</h2>
                ...
                <div class="col-lg-3 position-relative">
                        ...
                        <ul class="nav nav-list flex-column p-relative right-9">
                            ...
                            <li class="nav-item">
                                ...
                                <ul>
                                    ...
                                    <li class="nav-item"><a class="nav-link bg-transparent border-0" href="#">Software
                                            Testing</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link bg-transparent border-0" href="#">Personal
                                    Development (3)</a></li>
                            <li class="nav-item"><a class="nav-link bg-transparent border-0" href="#">Business (2)</a>
                            </li>
                    ...
                    <div class="mt-2 mb-4 pb-2">
                        ...
                        <h2 class="text-color-secondary font-weight-semi-bold text-5 line-height-1 mb-3">Latest Courses
                        </h2>
